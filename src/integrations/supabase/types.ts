  ...
  public: {
    Tables: {
      ...
      project_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_types_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      report_imp_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "report_imp_files_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
      ...
      solution_features: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "solution_features_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      solutions: {
        ...
        Relationships: [
          {
            foreignKeyName: "solutions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      tenant_guard: { Args: { _tenant_id: string }; Returns: boolean }
